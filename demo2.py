...
def draw_audio_text(frame,audio_text_to_show):
    ...
    画 audio 对应的文字
    '''
    cv2.putText(frame, audio_text_to_show, (10, 400), cv2.FONT_HERSHEY_PLAIN, 1.5, (128,0, 128), 2)
...
try:
    ...
    while True:
        ...
        if image is not None:
            ...
            frame[0:240, frame.shape[1]-320:frame.shape[1], :  ] = \
                frame[0:240, frame.shape[1]-320:frame.shape[1], :  ] * 0.6 + image * 0.4
